    ...
    <section id="download" className="relative stripes-dark py-24 sm:py-28">
      <div className="mx-auto max-w-6xl px-4">
        <SectionHeading
          ...
          title="Download"
          body="Free. No account, no installer. Unzip and run. The build is not code-signed yet, so each OS shows a one-time warning the first time you open it. The steps below get you past it."
        />
        ...
        <p className="mt-8 text-center text-sm font-bold text-cream-dim">
          ...
          . The game also updates itself from Options on the title screen.
